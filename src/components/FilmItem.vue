...
<template>
   <ul v-for="film in this.store.films" class="list-unstyled m-auto">
      ...
      <!-- Stars -->
      <li>
         <svg v-for="num in transformVote(film.vote_average)" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
